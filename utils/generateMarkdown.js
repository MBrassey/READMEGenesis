...
<h6><p align="right">:cyclone: Click the image(s) below to view the live <a  id="Screenshots" href="https://${
    data.gitHub
  }.github.io/${data.title}/">webapplication</a></p></h6>
...
#### Questions
Contact me at [${data.contact}](mailto:${
    data.contact
